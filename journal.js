...
function createJurnalCard(jurnal, masterKelasData, masterMapelData) {
    ...
    headerDiv.className = 'jurnal-header';
    headerDiv.innerHTML = `
    ...
    contentDiv.className = 'jurnal-content';
...
async function loadAllJurnalGuru(daftarSemuaJurnalContainer, masterKelasData, masterMapelData) {
